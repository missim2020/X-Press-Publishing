...
const sql = 'SELECT * FROM Artist WHERE Artist.id=$srtistId';
...
artistsRouter.put('/:artistId', (req,res,next)=>{
    ...
    const sql = 'UPDATE Artist SET name=$name, date_of_birth= $dateOfBirth, biography=$biography, is_currently_emplyed=$isCurrentlyEmployes'+
